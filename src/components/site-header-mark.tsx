...
import { RahulMark } from "./rahul-mark"
...
function RahulMarkMotion() {
  ...
  return (
    ...
    >
      <RahulMark className="-translate-y-2 opacity-0 transition-[opacity,translate] duration-300 group-data-[visible=true]/mark-motion:translate-y-0 group-data-[visible=true]/mark-motion:opacity-100" />
    </div>
  )
}
...
export function SiteHeaderMark() {
  ...
  return isHome ? <RahulMarkMotion /> : <RahulMark />
}
